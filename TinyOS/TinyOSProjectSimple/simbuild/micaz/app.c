...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bf3458, const void *arg_0xb7bf35f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ba68c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a50840), 
int (*key_eq_fn)(void *arg_0xb7a50c88, void *arg_0xb7a50e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb791f9b8, int arg_0xb791fb10);
static double RandomUniform(void );
...
typedef TMilli projectSinkC$DataTimer$precision_tag;
typedef TMilli projectSinkC$LocalTime$precision_tag;
typedef uint32_t projectSinkC$Read$val_t;
typedef TMilli projectSinkC$TresholdTimer$precision_tag;
...
typedef TMilli /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint32_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void projectSinkC$AMControl$startDone(error_t error);
#line 138
static void projectSinkC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void projectSinkC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void projectSinkC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void projectSinkC$DataTimer$fired(void );
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void projectSinkC$Read$readDone(error_t result, projectSinkC$Read$val_t val);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectSinkC$TresholdTimer$fired(void );
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t projectSinkC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t projectSinkC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
projectSinkC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t projectSinkC$Read$read(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t projectSinkC$Ack$requestAck(
#line 53
message_t * msg);
#line 85
static bool projectSinkC$Ack$wasAcked(
#line 80
message_t * msg);
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectSinkC$TresholdTimer$startPeriodicAt(uint32_t t0, uint32_t dt);
# 37 "projectSinkC.nc"
message_t projectSinkC$packet[1000];
bool projectSinkC$locked[1000];
uint32_t projectSinkC$treshold[1000];
uint16_t projectSinkC$treshold_id[1000];
uint8_t projectSinkC$parent[1000];
uint8_t projectSinkC$children[1000][2];
uint8_t projectSinkC$index[1000];
uint16_t projectSinkC$counter[1000];
bool projectSinkC$mess_to_send[1000];
Msg_t *projectSinkC$saved_mess[1000];




static void projectSinkC$sendData(uint32_t data, uint16_t source, uint32_t time);
static void projectSinkC$sendTreshold(uint32_t time);
static void projectSinkC$sendDiscovery(uint16_t id);
static inline void projectSinkC$sendDiscoveryAck(uint8_t destination);
static inline void projectSinkC$sendSetup(uint8_t destination, uint16_t id);





static inline void projectSinkC$Boot$booted(void );





static inline void projectSinkC$AMControl$startDone(error_t err);
#line 100
static inline void projectSinkC$AMControl$stopDone(error_t err);




static inline void projectSinkC$TresholdTimer$fired(void );
...
static inline void projectSinkC$DataTimer$fired(void );
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 189
static inline void projectSinkC$Read$readDone(error_t result, uint32_t dataRead);
#line 217
static void projectSinkC$AMSend$sendDone(message_t *buf, error_t err);
#line 259
static void projectSinkC$sendTreshold(uint32_t elapsed_time);
#line 288
static void projectSinkC$sendData(uint32_t data, uint16_t source, uint32_t elapsed_time);
#line 310
static void projectSinkC$sendDiscovery(uint16_t id);
#line 335
static inline void projectSinkC$sendDiscoveryAck(uint8_t destination);
...
#line 69
static inline uint32_t RandomMlcgC$Random$rand32(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 46 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint32_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32(void );
# 16 "FakeSensorP.nc"
static inline error_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t projectSinkC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t projectSinkC$Ack$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * projectSinkC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 359
{
  ...
  Msg_t *mess = (Msg_t *)projectSinkC$Packet$getPayload(&projectSinkC$packet[sim_node()], sizeof(Msg_t ));
...
#line 363
  ...
  __nesc_hton_uint32(mess->value.nxdata, projectSinkC$treshold[sim_node()]);
  __nesc_hton_uint16(mess->type.nxdata, 5);
  __nesc_hton_uint16(mess->source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->treshold_id.nxdata, id);

  if (!projectSinkC$locked[sim_node()]) {
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(destination, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(214U, "radio", "\n");
          sim_log_debug(215U, "radio", "Packet sent from: %hu, data: %lu, type: %hu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
          sim_log_debug(216U, "radio", "Message of discovery ack sent");
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(217U, "error", "\n");
          sim_log_debug(218U, "error", "Error in sending packet\n ");
        }
    }
}
...
#line 339
  __nesc_hton_uint16(mess->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint32(mess->value.nxdata, 0);
  __nesc_hton_uint16(mess->type.nxdata, 4);
  __nesc_hton_uint16(mess->source.nxdata, TOS_NODE_ID);

  if (!projectSinkC$locked[sim_node()]) {
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(destination, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(209U, "radio", "\n");
          sim_log_debug(210U, "radio", "Packet sent from: %hu, data: %lu, type: %hu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
          sim_log_debug(211U, "radio", "Message of discovery ack sent");
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(212U, "error", "\n");
          sim_log_debug(213U, "error", "Error in sending packet\n ");
        }
    }
}
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  ...
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 3 && projectSinkC$treshold_id[sim_node()] < __nesc_ntoh_uint16(mess->treshold_id.nxdata)) {
      sim_log_debug_clear(157U, "radio", "\n");
      sim_log_debug(158U, "radio", "first discovery riceived from %d\n", __nesc_ntoh_uint16(mess->sender.nxdata));

      projectSinkC$parent[sim_node()] = 0;
      projectSinkC$children[sim_node()][0] = 0;
      projectSinkC$children[sim_node()][1] = 0;
      projectSinkC$sendDiscoveryAck(__nesc_ntoh_uint16(mess->sender.nxdata));
    }
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 4) {
      if (projectSinkC$index[sim_node()] <= 2) {
          projectSinkC$children[sim_node()][projectSinkC$index[sim_node()]] = __nesc_ntoh_uint16(mess->sender.nxdata);
          sim_log_debug_clear(159U, "radio", "\n");
          sim_log_debug(160U, "radio", "discovery ack riceived from %d, setting child %d to %d\n", __nesc_ntoh_uint16(mess->sender.nxdata), projectSinkC$index[sim_node()], projectSinkC$children[sim_node()][projectSinkC$index[sim_node()]]);
          projectSinkC$index[sim_node()] += 1;
          projectSinkC$sendSetup(__nesc_ntoh_uint16(mess->sender.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
        }
    }
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 5) {
      projectSinkC$parent[sim_node()] = __nesc_ntoh_uint16(mess->sender.nxdata);
      projectSinkC$treshold[sim_node()] = __nesc_ntoh_uint32(mess->value.nxdata);
      projectSinkC$treshold_id[sim_node()] = __nesc_ntoh_uint16(mess->treshold_id.nxdata);
      sim_log_debug_clear(161U, "radio", "\n");
      sim_log_debug(162U, "radio", "setup message riceived from %d, setting parent to %d\n", __nesc_ntoh_uint16(mess->sender.nxdata), projectSinkC$parent[sim_node()]);
      projectSinkC$sendDiscovery(projectSinkC$treshold_id[sim_node()]);
    }

  if (__nesc_ntoh_uint16(mess->type.nxdata) == 1) {
      projectSinkC$treshold[sim_node()] = __nesc_ntoh_uint32(mess->value.nxdata);
      sim_log_debug_clear(163U, "radio", "\n");
      sim_log_debug(164U, "radio", "Mote %hu has received a treshold message with treshold %lu from mote %hu\n", TOS_NODE_ID, projectSinkC$treshold[sim_node()], __nesc_ntoh_uint16(mess->sender.nxdata));
      sim_log_debug_clear(165U, "analysis", "\n");
      sim_log_debug(166U, "analysis", "Time for treshold %lu message from sink to %hu is : %lu ms\n", projectSinkC$treshold[sim_node()], TOS_NODE_ID, sim_time() - __nesc_ntoh_uint32(mess->time.nxdata));
      sim_log_debug(167U, "analysis", "current simulation time: %s\n", sim_time_string());
      projectSinkC$sendTreshold(__nesc_ntoh_uint32(mess->time.nxdata));
    }

  if (__nesc_ntoh_uint16(mess->type.nxdata) == 2) {
      if (TOS_NODE_ID == 1) {
          sim_log_debug_clear(168U, "sink", "\n");
          sim_log_debug(169U, "sink", "Sink node received data message from %hu with data %lu at time %s\n", __nesc_ntoh_uint16(mess->source.nxdata), __nesc_ntoh_uint32(mess->value.nxdata), sim_time_string());
          projectSinkC$counter[sim_node()] += 1;
          sim_log_debug_clear(170U, "analysis", "\n");
          sim_log_debug(171U, "analysis", "Data Message counter: %hu\n", projectSinkC$counter[sim_node()]);
          sim_log_debug_clear(172U, "analysis", "\n");
          sim_log_debug(173U, "analysis", "Time for data message %lu from %hu to sink is : %lu ms\n", __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->source.nxdata), sim_time() - __nesc_ntoh_uint32(mess->time.nxdata));
          sim_log_debug(174U, "analysis", "current simulation time: %s\n", sim_time_string());
        }
      else {
          sim_log_debug_clear(175U, "data", "\n");
          sim_log_debug(176U, "data", "Mote %hu has received a data message with data %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata));
          projectSinkC$sendData(__nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->source.nxdata), __nesc_ntoh_uint32(mess->time.nxdata));
        }
    }
  return buf;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76c2ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76c2ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = projectSinkC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76c2ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb736e2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb736e2b0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(246U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(247U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(248U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(249U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76c2108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76c2108, msg, error);
#line 110
}
#line 110
...
inline static bool projectSinkC$Ack$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76c0178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76c0178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t projectSinkC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectSinkC$TresholdTimer$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodicAt(0U, t0, dt);
#line 114
}
#line 114
# 67 "projectSinkC.nc"
...
{
  if (err == SUCCESS) {
      sim_log_debug(148U, "boot", "Booting ... I'm node : %d, Radio started at time: %s \n", TOS_NODE_ID, sim_time_string());
      if (TOS_NODE_ID == 1) {

          projectSinkC$treshold_id[sim_node()] = 0;
          projectSinkC$children[sim_node()][0] = 0;
          projectSinkC$children[sim_node()][1] = 0;
          projectSinkC$parent[sim_node()] = 1;
          sim_log_debug(149U, "boot", "node %d: booted, child1 : %d , child2 : %d\n", TOS_NODE_ID, projectSinkC$children[sim_node()][0], projectSinkC$children[sim_node()][1]);
          projectSinkC$TresholdTimer$startPeriodicAt(0, 80000);
        }
      else {

          projectSinkC$treshold[sim_node()] = 4294967295;
          projectSinkC$children[sim_node()][0] = 0;
          projectSinkC$children[sim_node()][1] = 0;
          projectSinkC$parent[sim_node()] = 0;
          projectSinkC$treshold_id[sim_node()] = 0;
          sim_log_debug(150U, "boot", "node %d: booted, child1 : %d , child2 : %d , parent: %d \n", TOS_NODE_ID, projectSinkC$children[sim_node()][0], projectSinkC$children[sim_node()][1], projectSinkC$parent[sim_node()]);
        }
    }
  else 

    {
      sim_log_debug_clear(151U, "error", "\n");
      sim_log_error(152U, "error", "Error in booting the radio\n");
      projectSinkC$AMControl$start();
    }
}
...
#line 113
  projectSinkC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  projectSinkC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  projectSinkC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73708a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73708a8) {
#line 100
    case 0U:
#line 100
      /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73708a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb787b650){
#line 75
  switch (arg_0xb787b650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb787b650);
#line 75
      break;
#line 75
    }
...
#line 53
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 16
{
  /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t projectSinkC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
static inline void projectSinkC$TresholdTimer$fired(void )
{
  sim_log_debug_clear(153U, "timer", "\n");
  sim_log_debug(154U, "timer", "Treshold timer fired at %s.\n", sim_time_string());
  projectSinkC$Read$read();
}

static inline void projectSinkC$DataTimer$fired(void )
{
  sim_log_debug_clear(155U, "timer", "\n");
  sim_log_debug(156U, "timer", "Data timer fired at %s.\n", sim_time_string());
  projectSinkC$Read$read();
}
...
# 46 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint32_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32(void ){
#line 46
  unsigned int __nesc_result;
#line 46
...
{
  if (TOS_NODE_ID == 1) {
      projectSinkC$treshold[sim_node()] = dataRead;
      projectSinkC$treshold_id[sim_node()] += 1;
      sim_log_debug_clear(177U, "sink", "\n");
      sim_log_debug(178U, "sink", "Sink just read new treshold %lu, with id %d\n", dataRead, projectSinkC$treshold_id[sim_node()]);
      if (projectSinkC$treshold_id[sim_node()] == 1 || projectSinkC$treshold_id[sim_node()] % 10 == 0) {
          projectSinkC$sendDiscovery(projectSinkC$treshold_id[sim_node()]);
          sim_log_debug_clear(179U, "sink", "\n");
          sim_log_debug(180U, "sink", "Sink is sending discovery");
        }
      else {
          projectSinkC$sendTreshold(sim_time());
        }
    }
  else 
    {
      if (dataRead > projectSinkC$treshold[sim_node()]) {
          sim_log_debug_clear(181U, "data", "\n");
          sim_log_debug(182U, "data", "Mote %hu just read new data %lu above the treshold %lu at time %s\n", TOS_NODE_ID, dataRead, projectSinkC$treshold[sim_node()], sim_time_string());
          projectSinkC$sendData(dataRead, TOS_NODE_ID, sim_time());
        }
    }
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  projectSinkC$Read$readDone(result, val);
#line 63
}
#line 63
# 22 "FakeSensorP.nc"
...
#line 22
{
  /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand32());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73eb3a8){
#line 83
  switch (arg_0xb73eb3a8) {
#line 83
    case 0U:
#line 83
      projectSinkC$TresholdTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      projectSinkC$DataTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73eb3a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(245U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(244U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(241U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(242U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(234U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(224U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(231U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(236U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 55
{
  /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*projectSinkAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
static void projectSinkC$AMSend$sendDone(message_t *buf, error_t err)
{
  if (&projectSinkC$packet[sim_node()] == buf) {
      projectSinkC$locked[sim_node()] = FALSE;
      if (err == SUCCESS) {
          if (projectSinkC$Ack$wasAcked(buf)) {
              sim_log_debug_clear(183U, "radio", "\n");
              sim_log_debug(184U, "radio", "Packet sent at time %s from %hu \n", sim_time_string(), TOS_NODE_ID);
              sim_log_debug_clear(185U, "radio", "\n");
              sim_log_debug(186U, "radio", "Message correctly delivered\n");
              sim_log_debug_clear(187U, "analysis", "\n");
              if (projectSinkC$mess_to_send[sim_node()] && projectSinkC$children[sim_node()][1] != 0) {
                  Msg_t *mess = (Msg_t *)projectSinkC$Packet$getPayload(&projectSinkC$packet[sim_node()], sizeof(Msg_t ));

                  mess = projectSinkC$saved_mess[sim_node()];
                  projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
                  if (projectSinkC$AMSend$send(projectSinkC$children[sim_node()][1], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
                      sim_log_debug_clear(188U, "radio", "\n");
                      sim_log_debug(189U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold_id: %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
                      sim_log_debug(190U, "radio", "Message to the second child %d", projectSinkC$children[sim_node()][0]);
                      projectSinkC$locked[sim_node()] = TRUE;
                    }
                  else {
                      sim_log_debug_clear(191U, "error", "\n");
                      sim_log_debug(192U, "error", "Error in sending packet\n ");
                    }
                }
              projectSinkC$mess_to_send[sim_node()] = FALSE;
            }
          else 
            {
              sim_log_debug_clear(193U, "error", "\n");
              sim_log_debug(194U, "error", "Error in sending packet, send the request again\n");
            }
        }
      else {
          sim_log_debug_clear(195U, "error", "\n");
          sim_log_error(196U, "error", "Error in sending packet, send the request again\n");
        }
    }
}
...
#line 314
  __nesc_hton_uint16(mess->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint32(mess->value.nxdata, 0);
  __nesc_hton_uint16(mess->type.nxdata, 3);
  __nesc_hton_uint16(mess->source.nxdata, 1);
  __nesc_hton_uint16(mess->treshold_id.nxdata, id);

  if (!projectSinkC$locked[sim_node()]) {
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(204U, "radio", "\n");
          sim_log_debug(205U, "radio", "Packet sent from: %hu, data: %lu, type: %hu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
          sim_log_debug(206U, "radio", "Message of discovery sent");
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(207U, "error", "\n");
          sim_log_debug(208U, "error", "Error in sending packet\n ");
        }
    }
}
...
#line 263
  __nesc_hton_uint16(mess->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint32(mess->value.nxdata, projectSinkC$treshold[sim_node()]);
  __nesc_hton_uint16(mess->type.nxdata, 1);
  __nesc_hton_uint16(mess->source.nxdata, 1);
  __nesc_hton_uint32(mess->time.nxdata, elapsed_time);

  if (!projectSinkC$locked[sim_node()] && projectSinkC$children[sim_node()][0] != 0) {
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(projectSinkC$children[sim_node()][0], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(197U, "radio", "\n");
          sim_log_debug(198U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold_id: %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
          sim_log_debug(199U, "radio", "Message to the first child %d", projectSinkC$children[sim_node()][0]);
          projectSinkC$locked[sim_node()] = TRUE;
          projectSinkC$mess_to_send[sim_node()] = TRUE;
          projectSinkC$saved_mess[sim_node()] = mess;
        }
      else {
          sim_log_debug_clear(200U, "error", "\n");
          sim_log_debug(201U, "error", "Error in sending packet\n ");
        }
    }
}
...
#line 291
  __nesc_hton_uint16(mess->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint32(mess->value.nxdata, data);
  __nesc_hton_uint16(mess->type.nxdata, 2);
  __nesc_hton_uint16(mess->source.nxdata, source);
  __nesc_hton_uint32(mess->time.nxdata, elapsed_time);

  if (!projectSinkC$locked[sim_node()]) {
      if (projectSinkC$parent[sim_node()] != 0) {
          projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
          if (projectSinkC$AMSend$send(projectSinkC$parent[sim_node()], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
              sim_log_debug_clear(202U, "radio", "\n");
              sim_log_debug(203U, "radio", "Packet sent from: %hu, to: %hu , data: %lu, type: %hu\n ", TOS_NODE_ID, projectSinkC$parent[sim_node()], __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
              projectSinkC$locked[sim_node()] = TRUE;
            }
        }
    }
...
#line 285
  ...
  sim_log_debug(233U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(239U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(219U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(220U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(221U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(222U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(240U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(243U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(232U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module projectSinkC */
  if (!strcmp(varname, "projectSinkC$packet"))
  {
    *addr = (uintptr_t)&projectSinkC$packet[__nesc_mote];
    *size = sizeof(projectSinkC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$locked"))
  {
    *addr = (uintptr_t)&projectSinkC$locked[__nesc_mote];
    *size = sizeof(projectSinkC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$treshold"))
  {
    *addr = (uintptr_t)&projectSinkC$treshold[__nesc_mote];
    *size = sizeof(projectSinkC$treshold[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$treshold_id"))
  {
    *addr = (uintptr_t)&projectSinkC$treshold_id[__nesc_mote];
    *size = sizeof(projectSinkC$treshold_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$parent"))
  {
    *addr = (uintptr_t)&projectSinkC$parent[__nesc_mote];
    *size = sizeof(projectSinkC$parent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$children"))
  {
    *addr = (uintptr_t)&projectSinkC$children[__nesc_mote];
    *size = sizeof(projectSinkC$children[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$index"))
  {
    *addr = (uintptr_t)&projectSinkC$index[__nesc_mote];
    *size = sizeof(projectSinkC$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$counter"))
  {
    *addr = (uintptr_t)&projectSinkC$counter[__nesc_mote];
    *size = sizeof(projectSinkC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$mess_to_send"))
  {
    *addr = (uintptr_t)&projectSinkC$mess_to_send[__nesc_mote];
    *size = sizeof(projectSinkC$mess_to_send[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$saved_mess"))
  {
    *addr = (uintptr_t)&projectSinkC$saved_mess[__nesc_mote];
    *size = sizeof(projectSinkC$saved_mess[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module projectSinkC */
  memset((void *)&projectSinkC$packet[__nesc_mote], 0, sizeof projectSinkC$packet[__nesc_mote]);
  projectSinkC$locked[__nesc_mote] = FALSE;
  memset((void *)&projectSinkC$treshold[__nesc_mote], 0, sizeof projectSinkC$treshold[__nesc_mote]);
  memset((void *)&projectSinkC$treshold_id[__nesc_mote], 0, sizeof projectSinkC$treshold_id[__nesc_mote]);
  memset((void *)&projectSinkC$parent[__nesc_mote], 0, sizeof projectSinkC$parent[__nesc_mote]);
  memset((void *)&projectSinkC$children[__nesc_mote], 0, sizeof projectSinkC$children[__nesc_mote]);
  projectSinkC$index[__nesc_mote] = 0;
  memset((void *)&projectSinkC$counter[__nesc_mote], 0, sizeof projectSinkC$counter[__nesc_mote]);
  memset((void *)&projectSinkC$mess_to_send[__nesc_mote], 0, sizeof projectSinkC$mess_to_send[__nesc_mote]);
  memset((void *)&projectSinkC$saved_mess[__nesc_mote], 0, sizeof projectSinkC$saved_mess[__nesc_mote]);
