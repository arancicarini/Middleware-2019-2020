...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bdf458, const void *arg_0xb7bdf5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b928c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a3c840), 
int (*key_eq_fn)(void *arg_0xb7a3cc88, void *arg_0xb7a3ce00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb790b9b8, int arg_0xb790bb10);
static double RandomUniform(void );
...
uint16_t projectSinkC$sink_treshold_id[1000];
uint8_t projectSinkC$parent[1000];
uint8_t projectSinkC$emergency_parent[1000];
uint8_t projectSinkC$childs[1000][2];
uint8_t projectSinkC$index[1000];
uint8_t projectSinkC$index1[1000];
uint16_t projectSinkC$counter[1000];
Msg_t *projectSinkC$q1[1000][10];
uint8_t projectSinkC$q1_index[1000];
bool projectSinkC$q1_full[1000];


static void projectSinkC$sendData(uint32_t data, uint16_t source, uint32_t time);
static void projectSinkC$sendTreshold(uint32_t time, uint16_t t_id);
static void projectSinkC$sendDiscovery(void );
static void projectSinkC$sendDiscoveryAck(uint8_t destination, uint8_t type);

static void projectSinkC$inizializing(void );
...
#line 249
static void projectSinkC$sendTreshold(uint32_t elapsed_time, uint16_t t_id);
#line 289
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  ...
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 3) {
      projectSinkC$sendDiscovery();
      ...
      projectSinkC$emergency_parent[sim_node()] = __nesc_ntoh_uint16(mess->sender.nxdata);
      sim_log_debug_clear(157U, "radio", "\n");
      sim_log_debug(158U, "radio", "first discovery riceived from %d, setting emergency parent to %d\n", __nesc_ntoh_uint16(mess->sender.nxdata), projectSinkC$emergency_parent[sim_node()]);
      projectSinkC$sendDiscoveryAck(__nesc_ntoh_uint16(mess->sender.nxdata), 4);
    }
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 4) {
      if (projectSinkC$index[sim_node()] <= 2) {
          projectSinkC$childs[sim_node()][projectSinkC$index[sim_node()]] = __nesc_ntoh_uint16(mess->sender.nxdata);
          sim_log_debug_clear(159U, "radio", "\n");
          sim_log_debug(160U, "radio", "discovery ack riceived from %d, setting child %d to %d\n", __nesc_ntoh_uint16(mess->sender.nxdata), projectSinkC$index[sim_node()], projectSinkC$childs[sim_node()][projectSinkC$index[sim_node()]]);
          projectSinkC$index[sim_node()] += 1;
          projectSinkC$sendDiscoveryAck(__nesc_ntoh_uint16(mess->sender.nxdata), 5);
        }
    }
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 5) {
      ...
      sim_log_debug(162U, "radio", "discovery ack reply (second ack) riceived from %d, setting parent to %d\n", __nesc_ntoh_uint16(mess->sender.nxdata), projectSinkC$parent[sim_node()]);
    }

  if (__nesc_ntoh_uint16(mess->type.nxdata) == 1 && projectSinkC$treshold_id[sim_node()] < __nesc_ntoh_uint16(mess->treshold_id.nxdata)) {
      projectSinkC$treshold[sim_node()] = __nesc_ntoh_uint32(mess->value.nxdata);
      projectSinkC$treshold_id[sim_node()] = __nesc_ntoh_uint16(mess->treshold_id.nxdata);
      ...
      projectSinkC$sendTreshold(__nesc_ntoh_uint32(mess->time.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76aeac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76aeac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76aeac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73612b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73612b0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76ae108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76ae108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76ac178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76ac178, msg, payload, len);
#line 78
...
static inline void projectSinkC$AMControl$startDone(error_t err)
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          ...
          projectSinkC$sink_treshold_id[sim_node()] = 0;
          projectSinkC$childs[sim_node()][0] = 0;
          projectSinkC$childs[sim_node()][1] = 0;
          projectSinkC$parent[sim_node()] = 1;
          projectSinkC$emergency_parent[sim_node()] = 0;
          projectSinkC$inizializing();
          sim_log_debug(149U, "boot", "node %d: booted, child1 : %d , child2 : %d\n", TOS_NODE_ID, projectSinkC$childs[sim_node()][0], projectSinkC$childs[sim_node()][1]);
          ...
          projectSinkC$emergency_parent[sim_node()] = 0;
          projectSinkC$inizializing();
          sim_log_debug(150U, "boot", "node %d: booted, child1 : %d , child2 : %d , parent: %d , emergency_parent: %d\n", TOS_NODE_ID, projectSinkC$childs[sim_node()][0], projectSinkC$childs[sim_node()][1], projectSinkC$parent[sim_node()], projectSinkC$emergency_parent[sim_node()]);
        }
    }
  else 
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73638a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73638a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73638a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7867650){
#line 75
  switch (arg_0xb7867650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7867650);
#line 75
      break;
#line 75
    }
...
static inline void projectSinkC$Read$readDone(error_t result, uint32_t dataRead)
{
  if (TOS_NODE_ID == 1) {
      ...
      projectSinkC$sink_treshold_id[sim_node()] += 1;
      projectSinkC$treshold_id[sim_node()] += 1;
      sim_log_debug_clear(177U, "sink", "\n");
      sim_log_debug(178U, "sink", "Sink just read new treshold %lu, with id %d\n", dataRead, projectSinkC$sink_treshold_id[sim_node()]);
      if (projectSinkC$sink_treshold_id[sim_node()] == 1) {
          projectSinkC$sendDiscovery();
          sim_log_debug_clear(179U, "sink", "\n");
          sim_log_debug(180U, "sink", "Sink is sending first discovery");
        }
      projectSinkC$sendTreshold(sim_time(), projectSinkC$sink_treshold_id[sim_node()]);
    }
  else 
    {
...
#line 327
  ...
  __nesc_hton_uint16(mess->treshold_id.nxdata, 1);
  ...
  if (!projectSinkC$locked[sim_node()]) {
      ...
      if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          ...
          sim_log_debug(203U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold_id: %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
          sim_log_debug(204U, "radio", "Message of discovery sent");
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(205U, "error", "\n");
          sim_log_debug(206U, "error", "Error in sending packet\n ");
        }
    }
}
  ...
  if (&projectSinkC$packet[sim_node()] == buf) {
      ...
      if (err == SUCCESS) {
          if (projectSinkC$Ack$wasAcked(buf)) {
              ...
              sim_log_debug_clear(187U, "error", "\n");
              sim_log_debug(188U, "error", "Error in sending packet, send the request again\n");
            }
        }
    }
  else 
    ...
    {
      sim_log_debug_clear(189U, "error", "\n");
      sim_log_error(190U, "error", "Error in sending packet, send the request again\n");
    }
}
...
#line 352
  __nesc_hton_uint16(mess->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint32(mess->value.nxdata, projectSinkC$treshold[sim_node()]);
  __nesc_hton_uint16(mess->type.nxdata, type);
  __nesc_hton_uint16(mess->source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->treshold_id.nxdata, projectSinkC$treshold_id[sim_node()]);

  if (!projectSinkC$locked[sim_node()]) {
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(destination, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(207U, "radio", "\n");
          sim_log_debug(208U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold_id: %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
          sim_log_debug(209U, "radio", "Message of discovery ack sent");
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(210U, "error", "\n");
          sim_log_debug(211U, "error", "Error in sending packet\n ");
        }
    }
}
...
#line 253
  ...
  __nesc_hton_uint16(mess->source.nxdata, 1);
  __nesc_hton_uint16(mess->treshold_id.nxdata, t_id);
  ...
  if (!projectSinkC$locked[sim_node()]) {
      ...
      projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
      if (projectSinkC$AMSend$send(projectSinkC$childs[sim_node()][projectSinkC$index1[sim_node()]], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          sim_log_debug_clear(191U, "radio", "\n");
          sim_log_debug(192U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold_id: %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
          sim_log_debug(193U, "radio", "Message to the first child %d", projectSinkC$childs[sim_node()][projectSinkC$index1[sim_node()]]);
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(194U, "error", "\n");
          sim_log_debug(195U, "error", "Error in sending packet\n ");
        }
    }
  else 
    {
      if (projectSinkC$q1_index[sim_node()] < 10) {
          projectSinkC$q1[sim_node()][projectSinkC$q1_index[sim_node()]] = mess;
          projectSinkC$q1_index[sim_node()] += 1;
          sim_log_debug_clear(196U, "error", "\n");
          sim_log_debug(197U, "error", "element in q1[%d]: %s\n ", projectSinkC$q1[sim_node()], projectSinkC$q1[sim_node()][projectSinkC$q1_index[sim_node()]]);
          projectSinkC$q1_full[sim_node()] = TRUE;
        }
    }
}
...
#line 292
  ...
  if (!projectSinkC$locked[sim_node()]) {
      if (projectSinkC$parent[sim_node()] == 0 && projectSinkC$emergency_parent[sim_node()] == 0) {
#line 299
        return;
        }
      else 
#line 300
        {
          if (projectSinkC$parent[sim_node()] != 0) {
              ...
              if (projectSinkC$AMSend$send(projectSinkC$parent[sim_node()], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
                  sim_log_debug_clear(198U, "radio", "\n");
                  sim_log_debug(199U, "radio", "Packet sent from: %hu, to: %hu , data: %lu, type: %hu\n ", TOS_NODE_ID, projectSinkC$parent[sim_node()], __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
                  projectSinkC$locked[sim_node()] = TRUE;
                }
            }
          else {
              projectSinkC$Ack$requestAck(&projectSinkC$packet[sim_node()]);
              if (projectSinkC$AMSend$send(projectSinkC$emergency_parent[sim_node()], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
                  sim_log_debug_clear(200U, "radio", "\n");
                  sim_log_debug(201U, "radio", "Packet sent from: %hu, to: %hu , data: %lu, type: %hu\n ", TOS_NODE_ID, projectSinkC$emergency_parent[sim_node()], __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
                  projectSinkC$locked[sim_node()] = TRUE;
                }
            }
        }
...
#line 374
{
  for (projectSinkC$q1_index[sim_node()] = 0; projectSinkC$q1_index[sim_node()] < 10; projectSinkC$q1_index[sim_node()]++) {
      projectSinkC$q1[sim_node()][projectSinkC$q1_index[sim_node()]] = 0;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "projectSinkC$sink_treshold_id"))
  {
    *addr = (uintptr_t)&projectSinkC$sink_treshold_id[__nesc_mote];
    *size = sizeof(projectSinkC$sink_treshold_id[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "projectSinkC$emergency_parent"))
  {
    *addr = (uintptr_t)&projectSinkC$emergency_parent[__nesc_mote];
    *size = sizeof(projectSinkC$emergency_parent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$childs"))
  {
    *addr = (uintptr_t)&projectSinkC$childs[__nesc_mote];
    *size = sizeof(projectSinkC$childs[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "projectSinkC$index1"))
  {
    *addr = (uintptr_t)&projectSinkC$index1[__nesc_mote];
    *size = sizeof(projectSinkC$index1[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "projectSinkC$q1"))
  {
    *addr = (uintptr_t)&projectSinkC$q1[__nesc_mote];
    *size = sizeof(projectSinkC$q1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$q1_index"))
  {
    *addr = (uintptr_t)&projectSinkC$q1_index[__nesc_mote];
    *size = sizeof(projectSinkC$q1_index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$q1_full"))
  {
    *addr = (uintptr_t)&projectSinkC$q1_full[__nesc_mote];
    *size = sizeof(projectSinkC$q1_full[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&projectSinkC$sink_treshold_id[__nesc_mote], 0, sizeof projectSinkC$sink_treshold_id[__nesc_mote]);
  memset((void *)&projectSinkC$parent[__nesc_mote], 0, sizeof projectSinkC$parent[__nesc_mote]);
  memset((void *)&projectSinkC$emergency_parent[__nesc_mote], 0, sizeof projectSinkC$emergency_parent[__nesc_mote]);
  memset((void *)&projectSinkC$childs[__nesc_mote], 0, sizeof projectSinkC$childs[__nesc_mote]);
  projectSinkC$index[__nesc_mote] = 0;
  projectSinkC$index1[__nesc_mote] = 0;
  memset((void *)&projectSinkC$counter[__nesc_mote], 0, sizeof projectSinkC$counter[__nesc_mote]);
  memset((void *)&projectSinkC$q1[__nesc_mote], 0, sizeof projectSinkC$q1[__nesc_mote]);
  projectSinkC$q1_index[__nesc_mote] = 0;
  projectSinkC$q1_full[__nesc_mote] = FALSE;
