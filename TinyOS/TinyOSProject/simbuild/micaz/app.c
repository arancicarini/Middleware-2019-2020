...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b61458, const void *arg_0xb7b615f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b148c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79be840), 
int (*key_eq_fn)(void *arg_0xb79bec88, void *arg_0xb79bee00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb788d9b8, int arg_0xb788db10);
static double RandomUniform(void );
...
typedef uint16_t projectSinkC$Read$val_t;
...
typedef uint16_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
uint16_t projectSinkC$treshold[1000];
uint8_t projectSinkC$nextHop[1000];
uint16_t projectSinkC$counter[1000];

static void projectSinkC$sendData(uint16_t data, uint16_t source, uint32_t time);
...
#line 142
static inline void projectSinkC$Read$readDone(error_t result, uint16_t dataRead);
#line 162
...
#line 212
static void projectSinkC$sendData(uint16_t data, uint16_t source, uint32_t elapsed_time);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  ...
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 2) {
      if (TOS_NODE_ID == 1) {
          ...
          sim_log_debug(161U, "sink", "Sink node received data message from %hu with data %hu at time %s\n", __nesc_ntoh_uint16(mess->source.nxdata), __nesc_ntoh_uint16(mess->value.nxdata), sim_time_string());
          ...
          sim_log_debug(168U, "data", "Mote %hu has received a data message with data %hu\n", TOS_NODE_ID, __nesc_ntoh_uint16(mess->value.nxdata));
          projectSinkC$sendData(__nesc_ntoh_uint16(mess->value.nxdata), __nesc_ntoh_uint16(mess->source.nxdata), __nesc_ntoh_uint32(mess->time.nxdata));
        }
    }
  return buf;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762e298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762e298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762e298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73132b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73132b0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb763d8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb763d8b0, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb762e930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb762e930, msg, payload, len);
#line 78
...
static inline void projectSinkC$AMControl$startDone(error_t err)
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          ...
          projectSinkC$treshold[sim_node()] = 65535;
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73148a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73148a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73148a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77e9650){
#line 75
  switch (arg_0xb77e9650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77e9650);
#line 75
      break;
#line 75
    }
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
static inline void projectSinkC$Read$readDone(error_t result, uint16_t dataRead)
{
  if (TOS_NODE_ID == 1) {
      ...
      sim_log_debug(170U, "sink", "Sink just read new treshold %hu\n", dataRead);
  ...
  else 
    {
      if (dataRead > projectSinkC$treshold[sim_node()]) {
          ...
          sim_log_debug(172U, "data", "Mote %hu just read new data %hu above the treshold %hu at time %s\n", TOS_NODE_ID, dataRead, projectSinkC$treshold[sim_node()], sim_time_string());
...
#line 24
{
  /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*projectSinkAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb738f3a8){
#line 83
  switch (arg_0xb738f3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb738f3a8);
#line 83
      break;
#line 83
    }
...
#line 191
      ...
      __nesc_hton_uint16(mess->value.nxdata, projectSinkC$treshold[sim_node()]);
      ...
      if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          ...
          sim_log_debug(182U, "radio", "Packet sent from: %hu, data: %hu, type: %hu\n elapsed time: ", TOS_NODE_ID, __nesc_ntoh_uint16(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
...
#line 222
        {
          ...
          if (projectSinkC$AMSend$send(projectSinkC$nextHop[sim_node()], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
              ...
              sim_log_debug(186U, "radio", "Packet sent from: %hu, to: %hu , data: %hu, type: %hu\n ", TOS_NODE_ID, projectSinkC$nextHop[sim_node()], __nesc_ntoh_uint16(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
              projectSinkC$locked[sim_node()] = TRUE;
            }
        }
    }
