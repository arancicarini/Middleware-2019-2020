...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c02458, const void *arg_0xb7c025f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bb58c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a5f840), 
int (*key_eq_fn)(void *arg_0xb7a5fc88, void *arg_0xb7a5fe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb792e9b8, int arg_0xb792eb10);
static double RandomUniform(void );
...
uint16_t projectSinkC$data[1000];
uint16_t projectSinkC$sink_treshold[1000];
uint16_t projectSinkC$mote_treshold[1000];
uint16_t projectSinkC$replyTo[1000];
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  sim_log_debug(157U, "error", "A new message is being read somewhere in the network\n");
  if (TOS_NODE_ID == 1) {
      Data_msg *mess = (Data_msg *)payload;

#line 124
      projectSinkC$data[sim_node()] = __nesc_ntoh_uint16(mess->value.nxdata);
      sim_log_debug(158U, "radio_pack", "Packet with data %hu\n", projectSinkC$data[sim_node()]);
      sim_log_debug(159U, "error", "sink node is reading a message\n");
    }
  else {
      Setup_msg *mess = (Setup_msg *)payload;

#line 130
      projectSinkC$mote_treshold[sim_node()] = __nesc_ntoh_uint16(mess->treshold.nxdata);
      projectSinkC$replyTo[sim_node()] = __nesc_ntoh_uint16(mess->sender.nxdata);
      projectSinkC$mote_treshold[sim_node()] = __nesc_ntoh_uint16(mess->treshold.nxdata);
      sim_log_debug(160U, "radio_pack", "Packet with new treshold: %hu \n", __nesc_ntoh_uint16(mess->treshold.nxdata));
      sim_log_debug(161U, "radio_rec", "Packet received at time %s\n", sim_time_string());
    }
  return buf;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76d1ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76d1ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76d1ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76cf178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76cf178, msg, payload, len);
#line 78
...
static inline void projectSinkC$AMControl$startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(149U, "boot", "I'm node : %d, Radio started at time: %s \n", TOS_NODE_ID, sim_time_string());
      if (TOS_NODE_ID == 1) {
          projectSinkC$sink_treshold[sim_node()] = 0;
          projectSinkC$TresholdTimer$startPeriodicAt(0, 1000);
        }
      else {
          projectSinkC$mote_treshold[sim_node()] = 0;
          projectSinkC$DataTimer$startPeriodicAt(0, 1000);
        }
    }
  else 
    {
      sim_log_error(150U, "error", "radio didn't start\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d1108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d1108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73cc8a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73cc8a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73cc8a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb788a650){
#line 75
  switch (arg_0xb788a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb788a650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73ca2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73ca2b0, addr, msg, len);
#line 80
...
static inline void projectSinkC$TresholdTimer$fired(void )
{
  ...
  sim_log_debug(152U, "timer", "timer fired at %s.\n", sim_time_string());
...
static inline void projectSinkC$DataTimer$fired(void )
{
  ...
  sim_log_debug(154U, "timer", "timer fired at %s.\n", sim_time_string());
  projectSinkC$Read$read();
}
...
{
  if (TOS_NODE_ID == 1) {
      Setup_msg *mess = (Setup_msg *)projectSinkC$Packet$getPayload(&projectSinkC$packet[sim_node()], sizeof(Setup_msg ));

#line 149
      projectSinkC$sink_treshold[sim_node()] = dataRead;
      sim_log_debug(162U, "treshold", "Sink has just red a new treshold %f\n", projectSinkC$sink_treshold[sim_node()]);
...
#line 152
      ...
      __nesc_hton_uint16(mess->treshold.nxdata, projectSinkC$sink_treshold[sim_node()]);

      sim_log_debug(163U, "error", "Sink node: read new treshold %hu\n", projectSinkC$sink_treshold[sim_node()]);
      if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Setup_msg )) == SUCCESS) 
        {
          sim_log_debug(164U, "radio_send", "Packet passed to lower layer successfully!\n");
          sim_log_debug(165U, "radio_pack", "Packet from : %hu, treshold: %hu\n", __nesc_ntoh_uint16(mess->sender.nxdata), __nesc_ntoh_uint16(mess->treshold.nxdata));
          projectSinkC$locked[sim_node()] = TRUE;
        }
    }
  else {
      if (dataRead > projectSinkC$mote_treshold[sim_node()]) {
          Data_msg *mess = (Data_msg *)projectSinkC$Packet$getPayload(&projectSinkC$packet[sim_node()], sizeof(Data_msg ));

#line 168
          sim_log_debug(166U, "data", "A mote has just read a value from the sensor %f\n", dataRead);
...
#line 171
          ...
          if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Data_msg )) == SUCCESS) 
            {
              sim_log_debug(167U, "radio_send", "Packet passed to lower layer successfully!\n");
              sim_log_debug(168U, "radio_pack", "Packet sent from identifier: %hu, data: %hu\n", __nesc_ntoh_uint16(mess->sender.nxdata), __nesc_ntoh_uint16(mess->value.nxdata));
              projectSinkC$locked[sim_node()] = TRUE;
            }
        }
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74473a8){
#line 83
  switch (arg_0xb74473a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74473a8);
#line 83
      break;
#line 83
    }
...
static inline void projectSinkC$Boot$booted(void )
{
  sim_log_debug(148U, "boot", "Application booted at time %s \n", sim_time_string());
  projectSinkC$AMControl$start();
}
  ...
  if (&projectSinkC$packet[sim_node()] == buf) 
    {
      ...
      if (err == SUCCESS) 
        {
          sim_log_debug(155U, "radio_send", "packet sent at time %s \n", sim_time_string());
        }
      else 
        {
          sim_log_error(156U, "error", "error in sending packet, send the request again\n");
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "projectSinkC$data"))
  {
    *addr = (uintptr_t)&projectSinkC$data[__nesc_mote];
    *size = sizeof(projectSinkC$data[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$sink_treshold"))
  {
    *addr = (uintptr_t)&projectSinkC$sink_treshold[__nesc_mote];
    *size = sizeof(projectSinkC$sink_treshold[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$mote_treshold"))
  {
    *addr = (uintptr_t)&projectSinkC$mote_treshold[__nesc_mote];
    *size = sizeof(projectSinkC$mote_treshold[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$replyTo"))
  {
    *addr = (uintptr_t)&projectSinkC$replyTo[__nesc_mote];
    *size = sizeof(projectSinkC$replyTo[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&projectSinkC$data[__nesc_mote], 0, sizeof projectSinkC$data[__nesc_mote]);
  memset((void *)&projectSinkC$sink_treshold[__nesc_mote], 0, sizeof projectSinkC$sink_treshold[__nesc_mote]);
  memset((void *)&projectSinkC$mote_treshold[__nesc_mote], 0, sizeof projectSinkC$mote_treshold[__nesc_mote]);
  memset((void *)&projectSinkC$replyTo[__nesc_mote], 0, sizeof projectSinkC$replyTo[__nesc_mote]);
