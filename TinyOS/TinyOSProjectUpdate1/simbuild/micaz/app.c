...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bdd458, const void *arg_0xb7bdd5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b908c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a3a840), 
int (*key_eq_fn)(void *arg_0xb7a3ac88, void *arg_0xb7a3ae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79099b8, int arg_0xb7909b10);
static double RandomUniform(void );
...
uint8_t len);
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void projectSinkC$DataTimer$startPeriodicAt(uint32_t t0, uint32_t dt);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
...
uint16_t projectSinkC$send_message[1000];
uint16_t projectSinkC$acked_message[1000];
uint16_t projectSinkC$discarded[1000];
...
static inline message_t *projectSinkC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  ...
  if (__nesc_ntoh_uint16(mess->type.nxdata) == 1 && __nesc_ntoh_uint16(mess->treshold_id.nxdata) > projectSinkC$treshold_id[sim_node()]) {
      ...
      sim_log_debug_clear(155U, "radio", "\n");
      sim_log_debug(156U, "radio", "Mote %hu has received a treshold message with treshold %lu from mote %hu\n", TOS_NODE_ID, projectSinkC$treshold[sim_node()], __nesc_ntoh_uint16(mess->sender.nxdata));
      sim_log_debug_clear(157U, "analysis", "\n");
      sim_log_debug(158U, "analysis", "Time for treshold %lu message from sink to %hu is : %lu ms\n", projectSinkC$treshold[sim_node()], TOS_NODE_ID, sim_time() - __nesc_ntoh_uint32(mess->time.nxdata));
      sim_log_debug(159U, "analysis", "current simulation time: %s\n", sim_time_string());
      projectSinkC$sendTreshold(__nesc_ntoh_uint32(mess->time.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
    }
  else {
      projectSinkC$discarded[sim_node()] += 1;
      sim_log_debug_clear(160U, "analysis", "\n");
      sim_log_debug(161U, "analysis", "Number of discarded messages: %d\n", projectSinkC$discarded[sim_node()]);
    }

  if (__nesc_ntoh_uint16(mess->type.nxdata) == 2) {
      if (TOS_NODE_ID == 1) {
          sim_log_debug_clear(162U, "sink", "\n");
          sim_log_debug(163U, "sink", "Sink node received data message from %hu with data %lu at time %s\n", __nesc_ntoh_uint16(mess->source.nxdata), __nesc_ntoh_uint32(mess->value.nxdata), sim_time_string());
          projectSinkC$counter[sim_node()] += 1;
          sim_log_debug_clear(164U, "analysis", "\n");
          sim_log_debug(165U, "analysis", "Data Message counter: %hu\n", projectSinkC$counter[sim_node()]);
          sim_log_debug_clear(166U, "analysis", "\n");
          sim_log_debug(167U, "analysis", "Time for data message %lu from %hu to sink is : %lu ms\n", __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->source.nxdata), sim_time() - __nesc_ntoh_uint32(mess->time.nxdata));
          sim_log_debug(168U, "analysis", "current simulation time: %s\n", sim_time_string());
        }
      else {
          sim_log_debug_clear(169U, "data", "\n");
          sim_log_debug(170U, "data", "Mote %hu has received a data message with data %lu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata));
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73872b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73872b0, addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76aa178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76aa178, msg, payload, len);
#line 78
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void projectSinkC$DataTimer$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodicAt(1U, t0, dt);
#line 114
}
#line 114
...
static inline void projectSinkC$AMControl$startDone(error_t err)
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          ...
          projectSinkC$send_message[sim_node()] = 0;
          projectSinkC$acked_message[sim_node()] = 0;
          projectSinkC$TresholdTimer$startPeriodicAt(0, 10000);
        }
      else {
          ...
          projectSinkC$send_message[sim_node()] = 0;
          projectSinkC$acked_message[sim_node()] = 0;
          projectSinkC$discarded[sim_node()] = 0;
          projectSinkC$DataTimer$startPeriodicAt(0, 1000);
        }
    }
  else 
    {
      sim_log_debug_clear(149U, "error", "\n");
      sim_log_error(150U, "error", "Error in booting the radio\n");
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73888a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73888a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73888a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7865650){
#line 75
  switch (arg_0xb7865650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7865650);
#line 75
      break;
#line 75
    }
...
static inline void projectSinkC$TresholdTimer$fired(void )
{
  sim_log_debug_clear(151U, "timer", "\n");
  sim_log_debug(152U, "timer", "Treshold timer fired at %s.\n", sim_time_string());
...
static inline void projectSinkC$DataTimer$fired(void )
{
  ...
  sim_log_debug(154U, "timer", "Data timer fired at %s.\n", sim_time_string());
  projectSinkC$Read$read();
}
...
static inline void projectSinkC$Read$readDone(error_t result, uint32_t dataRead)
{
  if (TOS_NODE_ID == 1) {
      ...
      sim_log_debug_clear(171U, "sink", "\n");
      sim_log_debug(172U, "sink", "Sink just read new treshold %lu\n", dataRead);
      projectSinkC$sendTreshold(sim_time(), projectSinkC$sink_treshold_id[sim_node()]);
    }
  else {
      if (dataRead > projectSinkC$treshold[sim_node()]) {
          sim_log_debug_clear(173U, "data", "\n");
          sim_log_debug(174U, "data", "Mote %hu just read new data %lu above the treshold %lu at time %s\n", TOS_NODE_ID, dataRead, projectSinkC$treshold[sim_node()], sim_time_string());
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74033a8){
#line 83
  switch (arg_0xb74033a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74033a8);
#line 83
      break;
#line 83
    }
...
#line 213
      ...
      if (projectSinkC$AMSend$send(AM_BROADCAST_ADDR, &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
          ...
          sim_log_debug(186U, "radio", "Packet sent from: %hu, data: %lu, type: %hu, treshold: %lu , treshold_id: %hu\n", TOS_NODE_ID, __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata), __nesc_ntoh_uint16(mess->treshold_id.nxdata));
          projectSinkC$locked[sim_node()] = TRUE;
        }
      else {
          sim_log_debug_clear(187U, "error", "\n");
          sim_log_debug(188U, "error", "Error in sending packet\n ");
        }
    }
}
  ...
  if (&projectSinkC$packet[sim_node()] == buf) {
      ...
      if (err == SUCCESS) {
          if (projectSinkC$Ack$wasAcked(buf)) {
              sim_log_debug_clear(175U, "radio", "\n");
              sim_log_debug(176U, "radio", "Packet sent at time %s from %hu \n", sim_time_string(), TOS_NODE_ID);
              sim_log_debug_clear(177U, "radio", "\n");
              sim_log_debug(178U, "radio", "Message correctly delivered\n");
              sim_log_debug_clear(179U, "analysis", "\n");
              sim_log_debug(180U, "analysis", "Messages NOT ackes %d \n", projectSinkC$send_message[sim_node()] - projectSinkC$acked_message[sim_node()]);
            }
          else {
              sim_log_debug_clear(181U, "error", "\n");
              sim_log_debug(182U, "error", "Error in sending packet, send the request again\n");
            }
        }
    }
  else 
    {
      sim_log_debug_clear(183U, "error", "\n");
      sim_log_error(184U, "error", "Error in sending packet, send the request again\n");
    }
}
...
#line 246
        {
          ...
          if (projectSinkC$AMSend$send(projectSinkC$parent[sim_node()], &projectSinkC$packet[sim_node()], sizeof(Msg_t )) == SUCCESS) {
              projectSinkC$send_message[sim_node()] += 1;
              sim_log_debug_clear(189U, "radio", "\n");
              sim_log_debug(190U, "radio", "Packet sent from: %hu, to: %hu , data: %lu, type: %hu\n ", TOS_NODE_ID, projectSinkC$parent[sim_node()], __nesc_ntoh_uint32(mess->value.nxdata), __nesc_ntoh_uint16(mess->type.nxdata));
              projectSinkC$locked[sim_node()] = TRUE;
            }
        }
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "projectSinkC$send_message"))
  {
    *addr = (uintptr_t)&projectSinkC$send_message[__nesc_mote];
    *size = sizeof(projectSinkC$send_message[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$acked_message"))
  {
    *addr = (uintptr_t)&projectSinkC$acked_message[__nesc_mote];
    *size = sizeof(projectSinkC$acked_message[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "projectSinkC$discarded"))
  {
    *addr = (uintptr_t)&projectSinkC$discarded[__nesc_mote];
    *size = sizeof(projectSinkC$discarded[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&projectSinkC$send_message[__nesc_mote], 0, sizeof projectSinkC$send_message[__nesc_mote]);
  memset((void *)&projectSinkC$acked_message[__nesc_mote], 0, sizeof projectSinkC$acked_message[__nesc_mote]);
  memset((void *)&projectSinkC$discarded[__nesc_mote], 0, sizeof projectSinkC$discarded[__nesc_mote]);
