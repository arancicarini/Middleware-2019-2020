...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b5c458, const void *arg_0xb7b5c5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b0d8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79b7840), 
int (*key_eq_fn)(void *arg_0xb79b7c88, void *arg_0xb79b7e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78869b8, int arg_0xb7886b10);
static double RandomUniform(void );
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$MilliTimer$startPeriodicAt(uint32_t t0, uint32_t dt);
#line 78
...
uint8_t sendAckC$rec_counter[1000];
...
#line 160
      ...
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 1 && TOS_NODE_ID == 2) 
        {
          sendAckC$rec_counter[sim_node()] = __nesc_ntoh_uint16(mess->counter.nxdata);
          sendAckC$sendResp();
          sim_log_debug(159U, "radio_pack", "Packet <>REQUEST<> RECV counter: %hu \n", __nesc_ntoh_uint16(mess->counter.nxdata));
          sim_log_debug(160U, "radio_rec", "Packet received at time %s\n", sim_time_string());
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 2 && TOS_NODE_ID == 1) 
        {
          sim_log_debug(161U, "radio_pack", "Packet <>RESPONSE<> RECV counter: %hu, value: %hu \n", __nesc_ntoh_uint16(mess->counter.nxdata), __nesc_ntoh_uint16(mess->value.nxdata));
          sim_log_debug(162U, "radio_rec", "Packet received at time %s\n", sim_time_string());
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762aac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762aac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762aac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7627178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7627178, msg, payload, len);
#line 78
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$MilliTimer$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
static inline void sendAckC$SplitControl$startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(150U, "role", "I'm node : %d, Radio started at time: %s \n", TOS_NODE_ID, sim_time_string());
      if (TOS_NODE_ID == 1) 
        {
          sendAckC$MilliTimer$startPeriodicAt(0, 1000);
        }
      if (TOS_NODE_ID == 2) 
        {
        }
    ...
    {
      sim_log_error(151U, "error", "radio didn't start\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb762a108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb762a108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb732fca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb732fca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb732fca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77e2650){
#line 75
  switch (arg_0xb77e2650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77e2650);
#line 75
      break;
#line 75
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb732c730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb732c730, addr, msg, len);
#line 80
...
static inline void sendAckC$MilliTimer$fired(void )
{
  ...
  sim_log_debug(153U, "timer", "timer fired at %s.\n", sim_time_string());
  sendAckC$sendReq();
}
...
#line 188
  sim_log_debug(163U, "value", "value read done %f\n", value);
...
#line 190
  ...
  __nesc_hton_uint16(mess->counter.nxdata, sendAckC$rec_counter[sim_node()]);
  __nesc_hton_uint16(mess->value.nxdata, value);
  ...
  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
    {
      ...
      sim_log_debug(165U, "radio_pack", "Packet <>RESPONSE<> SENT counter: %hu, value: %hu\n", __nesc_ntoh_uint16(mess->counter.nxdata), __nesc_ntoh_uint16(mess->value.nxdata));
    }
  else {
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73a53a8){
#line 83
  switch (arg_0xb73a53a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73a53a8);
#line 83
      break;
#line 83
    }
...
static inline void sendAckC$Boot$booted(void )
{
  sim_log_debug(149U, "boot", "Application booted at time %s \n", sim_time_string());
  sendAckC$SplitControl$start();
}
  ...
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) 
    {
      ...
      if (sendAckC$Ack$wasAcked(buf)) 
        {
          sim_log_debug(155U, "radio_ack", "message acked! \n");
          if (TOS_NODE_ID == 1) {
            sendAckC$MilliTimer$stop();
            }
#line 131
          if (TOS_NODE_ID == 2) {
            sim_log_debug_clear(156U, "timer", "Routine finished!\n");
            }
        }
      else {
#line 135
        sim_log_debug(157U, "radio_ack", "message NOT acked! \n");
        }
#line 136
      sendAckC$locked[sim_node()] = FALSE;
    }
    ...
    {
      sim_log_error(158U, "error", "error in sending packet, send the request again\n");
      if (TOS_NODE_ID == 1) {
#line 142
        sendAckC$sendReq();
        }
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
    {
      ...
      sim_log_debug(148U, "radio_pack", "Packet <>REQUEST<> SENT counter: %hu \n", __nesc_ntoh_uint16(mess->counter.nxdata));
    }
  else {
    sendAckC$locked[sim_node()] = FALSE;
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$rec_counter"))
  {
    *addr = (uintptr_t)&sendAckC$rec_counter[__nesc_mote];
    *size = sizeof(sendAckC$rec_counter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&sendAckC$rec_counter[__nesc_mote], 0, sizeof sendAckC$rec_counter[__nesc_mote]);
